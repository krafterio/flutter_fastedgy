...
abstract class BaseModel {
  ...
  /// Create a model from a data map
  /// Automatically parses DateTime fields to local timezone
  BaseModel(Map<String, dynamic> data) : _data = _parseData(data);
  ...
  /// ```
  T? getField<T>(String name) => _data[name] as T?;
  ...
  /// setField<int>('age', 25);
  /// ```
  BaseModel setField<T>(String name, T? value) {
    _data[name] = value;
    return this;
  }
  ...
  /// Set a String field
  BaseModel setString(String name, String? value) =>
  ...
  /// Set an int field
  BaseModel setInt(String name, int? value) => setField<int>(name, value);

  /// Get a double field
  double? getDouble(String name) => getField<double>(name);

  /// Set a double field
  BaseModel setDouble(String name, double? value) =>
  ...
  /// Set a bool field
  BaseModel setBool(String name, bool? value) => setField<bool>(name, value);
  ...
  BaseModel setDateTime(String name, DateTime? value) =>
  ...
  BaseModel setDate(String name, DateTime? value) {
  ...
  /// Get a List field
  List<T>? getList<T>(String name) => getField<List<T>>(name);

  /// Set a List field
  BaseModel setList<T>(String name, List<T>? value) =>
      setField<List<T>>(name, value);
  ...
  /// Set a Map field
  BaseModel setMap(String name, Map<String, dynamic>? value) =>
